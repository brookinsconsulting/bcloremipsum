...
{include uri='design:parts/ini_menu.tpl' ini_section='Leftmenu_bcloremipsum_create' i18n_hash=hash(
             'create',  'Create nodes'|i18n( 'design/admin/parts/bcloremipsum/menu' ),
             'project', 'Extension project'|i18n( 'design/admin/parts/bcloremipsum/menu' ) )}
